...
public class Payment implements Serializable, IDataModel {
	...
	public Payment(String id, String receiptNo, String bankAccountNo, String referenceNo,
			PolicyReferenceType referenceType, double basicPremium, double addOnPremium, double discountPercent,
			double servicesCharges, double stampFees, boolean complete, String receivedDeno, String refundDeno,
			PaymentChannel paymentChannel, Bank bank) {
		this.id = id;
	...
	public double getNetPremium() {
		return getTotalPremium() - ncbPremium - getDiscountAmount() + getReinstatementPremium() + loanInterest - refund
				+ renewalInterest;
	}
