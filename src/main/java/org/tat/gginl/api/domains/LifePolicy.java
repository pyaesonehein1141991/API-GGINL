...
@TableGenerator(name = "LIFEPOLICY_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME",
    valueColumnName = "GEN_VAL", pkColumnValue = "LIFEPOLICY_GEN", allocationSize = 10)
...
public class LifePolicy implements IPolicy, Serializable, ISorter {
  ...
  @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "lifePolicy",
      orphanRemoval = true)
  ...
  public void setCustomerMedicalCheckUpAttachmentList(
      List<Attachment> customerMedicalCheckUpAttachmentList) {
