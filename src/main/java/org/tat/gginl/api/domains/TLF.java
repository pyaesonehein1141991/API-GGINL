...
public class TLF implements Serializable {
	...
	public TLF(String customerId, String coaId, double homeAmount, double localAmount, String currencyId, String chequeNo, String enoNo, String bankId, String purchaseOrderId,
			String loanId, String narration, String tranTypeId, String orgnTLFid, String branchId, double rate, Date settlementDate, boolean reverse, String referenceNo,
	...
	public TLF(double homeAmount, double localAmount, double rate, String currency, String chequeNo, String tranTypeId, String enoNo, String referenceNo, String bankId,
			String customerId, String branchId, String coaId, String narration, Date settlementDate, PolicyReferenceType referenceType, boolean isRenewal, String tlfNo) {
		this.homeAmount = homeAmount;
		this.localAmount = localAmount;
		this.rate = rate;
	...
	public TLF(String id, String prefix, String customerId, String coaId, double homeAmount, double localAmount, String currencyId, String chequeNo, String enoNo, String bankId,
			String purchaseOrderId, String loanId, String narration, String tranTypeId, String orgnTLFid, String branchId, double rate, Date settlementDate, boolean reverse,
			String referenceNo, PolicyReferenceType referenceType, boolean paid, String tlfNo, boolean clearing, boolean isRenewal, int version, Date createdDate, Date updatedDate,
