...
@Data
public class ShortTermSinglePremiumCreditLifeProposalInsuredPersonDTO {
	...
	private List<SinglePremiumCreditLifeInsuredPersonBeneficiaryDTO> insuredPersonBeneficiariesList;
	...
	@ApiModelProperty(position = 23, example = "Decreasing_SI", required = true)
	@NotBlank(message = "SumInsured type is mandatory")
