...
@Data
public class SinglePremiumEndowmentLifeProposalInsuredPersonDTO {
	...
	private List<SinglePremiumEndowmentLifeInsuredPersonBeneficiaryDTO> insuredPersonBeneficiariesList;
