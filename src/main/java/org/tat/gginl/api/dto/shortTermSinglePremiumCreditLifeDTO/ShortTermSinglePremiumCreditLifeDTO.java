package org.tat.gginl.api.dto.shortTermSinglePremiumCreditLifeDTO;
...
@Data
public class ShortTermSinglePremiumCreditLifeDTO {

	@ApiModelProperty(position = 0, example = "2020-07-09", required = true)
	...
	@ApiModelProperty(position = 5, example = "ISSYS002HO000000032329102013", required = true)
	...
	private List<ShortTermSinglePremiumCreditLifeProposalInsuredPersonDTO> proposalInsuredPersonList;
