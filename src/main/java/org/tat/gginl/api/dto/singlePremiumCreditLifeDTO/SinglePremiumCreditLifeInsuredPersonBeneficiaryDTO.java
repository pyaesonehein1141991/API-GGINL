...
@Data
public class SinglePremiumCreditLifeInsuredPersonBeneficiaryDTO {
	 ...
	 @ApiModelProperty(position = 0, example = "U", required = true)
	  ...
	  @ApiModelProperty(position = 11, example = "ISSYS001000005575112092016")
	  private String customerID;
	  
	  @ApiModelProperty(position = 12, example = "ISSYS033000009784102042019")
	  private String organizationID;
	  
	  @ApiModelProperty(position = 13)
	  @NotNull(message = "contentInfo is mandatory")
